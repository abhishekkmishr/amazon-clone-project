...
const Signin = () => {
  ...
  const [errEmail, setErrEmail] = useState("");
  const [errPassword, setErrPassword] = useState("");
  const [firebaseErr, setFirebaseErr] = useState(""); // Firebase Error state
      ...
      signInWithEmailAndPassword(auth, email, password)
        ...
        .catch((error) => {
          ...
          if (errorCode.includes("auth/user-not-found")) {
            setFirebaseErr("User not found. Please check your email and password.");
          } else if (errorCode.includes("auth/wrong-password")) {
            setFirebaseErr("Wrong password. Please try again.");
          } else {
            setFirebaseErr("Something went wrong. Please try again later.");
          }
          setLoading(false);
        });
